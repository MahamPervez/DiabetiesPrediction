...
url = 'http://4.157.218.232:80/api/v1/service/diabetiesclassfication/score'
api_key = '5X7Ze1EKngl1OSGY0KOERNZ8NrjMbQMX'
...
def predict():
    # Validate form data
    for field in ['Pregnancies', 'Glucose', 'BloodPressure', 'SkinThickness', 'Insulin', 'BMI',
    ...
    input_data = {
        ...
        # Include a dummy Outcome to match the schema
        "Outcome": 0
    }
    ...
    try:
        ...
        # Parse the result to get the predicted outcome
